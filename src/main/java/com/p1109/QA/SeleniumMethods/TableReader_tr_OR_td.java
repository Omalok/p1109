...
public class TableReader_tr_OR_td {

	static WebElement ele;
	static WebDriver driver;
	public TableReader_tr_OR_td(){
	...
	public static void main(String[] args) {
		TableReader_tr_OR_td obj = new TableReader_tr_OR_td();
		//To locate table.
		...
		for (int row=0; row<rows_count; row++){ 
			...
			//Columns_row.addAll(driver.findElements(By.tagName("td")));
